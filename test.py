...
class weather_test_case(unittest.TestCase):
    ...
    def test_dt_from_timestamp(self):
        tzlist = ["US/Hawaii", "America/Los_Angeles", "America/Denver", "America/Chicago", "America/New_York", "Asia/Shanghai", "Asia/Tokyo"]
    ...
    def build_location_file(self):
        ...
        if not os.path.exists(self.loclist_filepath):
            cities = ["Honolulu", "Oakland California", "Provo Utah", "Austin Tx", "New York City", "Hong Kong", "Tokyo Japan"]
            location_list = []
            for city in cities:
